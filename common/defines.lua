...
NCharacter = {
	...
	MERCHANT_REPUBLIC_MAX_PATRICIANS = 7,			-- The amount of merchant republic patrician families that the game will keep active.
...
NTechnology = {
	...
	IDEAL_YEAR_LEVEL_7 = 2300, 
	IDEAL_YEAR_LEVEL_8 = 2560,
